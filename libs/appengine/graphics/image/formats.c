 ...
 *    Name: loaders.c
 * Purpose: Loaders
 * Version: $Id: formats.c,v 1.3 2010-01-06 00:36:20 dpt Exp $
 * ----------------------------------------------------------------------- */
...
{
  bits    file_type;
  void  (*export_methods)(image_choices *, image *);
  osbool *load;
}
TypesData_map[] =
{
...
osbool loader_export_methods(image_choices *choices, image *image, bits file_type)
{
  int i;
