...
static error walk_in_order(ntree_t         *t,
...
static error walk_pre_order(ntree_t         *t,
                            ntree_walk_flags flags,
                            int              depth,
                            ntree_walk_fn   *fn,
                            void            *opaque)
...
static error walk_post_order(ntree_t         *t,
                             ntree_walk_flags flags,
                             int              depth,
                             ntree_walk_fn   *fn,
                             void            *opaque)
...
error ntree_walk(ntree_t         *t,
                 ntree_walk_flags flags,
                 int              max_depth,
                 ntree_walk_fn   *fn,
                 void            *opaque)
{
  error (*walker)(ntree_t *,
                  ntree_walk_flags,
                  int,
                  ntree_walk_fn *,
                  void *);
