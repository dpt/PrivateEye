/* --------------------------------------------------------------------------
 *    Name: atom.h
 * Purpose: Atoms - indexed data block store
 * ----------------------------------------------------------------------- */
...
#ifndef APPENGINE_ATOM_H
#define APPENGINE_ATOM_H
