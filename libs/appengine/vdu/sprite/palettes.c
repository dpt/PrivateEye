...
static const os_palette default_1bpp[] =
{
  0xffffff00, 0x00000000
};

static const os_palette default_2bpp[] =
{
  0xffffff00, 0xbbbbbb00, 0x77777700, 0x00000000
};

static const os_palette default_4bpp[] =
{
...
{
  static os_palette *palette = NULL;
...
const os_palette *get_default_palette(int log2bpp)
{
  switch (log2bpp)
  {
  case 0: return default_1bpp;
  case 1: return default_2bpp;
  case 2: return default_4bpp;
