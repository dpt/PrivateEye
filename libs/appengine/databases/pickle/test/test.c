...
static error test1_format_key(const void *key, char *buf, size_t len, void *opaque)
{
  NOT_USED(len);
  NOT_USED(opaque);
...
static error test1_format_value(const void *key, char *buf, size_t len, void *opaque)
{
  NOT_USED(len);
  NOT_USED(opaque);
...
static error cheese_format_key(const void *vkey, char *buf, size_t len, void *opaque)
{
...
static error cheese_format_value(const void *vvalue, char *buf, size_t len, void *opaque)
{
...
static error cheese_unformat_key(const char *buf,
                                 size_t      len,
                                 void      **key,
                                 void       *opaque)
{
...
static error cheese_unformat_value(const char *buf,
                                   size_t      len,
                                   void      **pvalue,
                                   void       *opaque)
{
